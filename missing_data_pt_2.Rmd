...
num_obs_combined %>% 
  ...
  labs(title = "Proportion of dyads versus missing data thresholds (proportion)",
       ...
       y = "Proportion of dyads remaining")
```
**take conservative, moderate, and liberal thresholds**
...
```
It thus seems that, although there are many observations throughout the dataset with observation gaps greater than the various thresholds, the number of dyads that would be lost if we simply excluded these cases is exceedingly low. 

...
# get proportion of cases with intervals greater than 4
date_diffs_sleep_t %>% 
  filter(interval < 5) %>% 
...
Ideally, we will run this again after making a choice about the proportion of missing data threshold to verify that no systematic relationship between number of observations for a dyad and the length of time between observations occurs. 
...
dyad_steps_diffs_df <- bind_rows(dyad_steps_diffs)
